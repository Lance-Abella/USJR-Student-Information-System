<?php
    ...
    $stmt1 = "SELECT progid, progfullname, progshortname, progcollid, progcolldeptid FROM programs LIMIT :offset, :rows_per_page";
    ...
    $total_rows_stmt = $conn->query("SELECT COUNT(*) as count FROM programs");
...
<body>
    ...
    <div class="container nav row">
        ...
        <div class="container col-md-4">
            <button type="submit" class="btn btn-outline-warning addbtn" onclick="window.location.href='program-entry.php'">Add Program</button>
        </div>
        ...
        <form action="" method="post" >
            <table class="table">
                ...
                <thead>
                    ...
                    <th scope="col">Program's College ID</th>
                    <th scope="col">Program's Department ID</th>
                    <th></th>
                    <th></th>
                ...
                <?php foreach ($result1 as $row): ?>
                    <tr>
                        ...
                        <td><?php echo $row['progshortname']; ?></td>
                        <td><?php echo $row['progcollid']; ?></td>
                        <td><?php echo $row['progcolldeptid']; ?></td>
                        <td>
                            <a href="program-edit.php?progid=<?php echo $row['progid']; ?>" class="btn btn-primary btn-sm">
                        ...
                        <td>
                            <a href="delete.php?progid=<?php echo $row['progid']; ?>" class="btn btn-danger btn-sm" onclick="return confirmAction()">                        
