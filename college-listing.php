<?php
    ...
    $stmt1 = "SELECT collid, collfullname, collshortname FROM colleges LIMIT :offset, :rows_per_page";
    ...
    $total_rows_stmt = $conn->query("SELECT COUNT(*) as count FROM colleges");
...
<body>
    ...
    <div class="container nav row">
        ...
        <div class="container col-md-4">
            <button type="submit" class="btn btn-outline-warning addbtn" onclick="window.location.href='college-entry.php'">Add College</button>
        </div>
        ...
        <form action="" method="post" >
            <table class="table">
                ...
                <?php foreach ($result1 as $row): ?>
                    <tr>
                        <td><?php echo $row['collid']; ?></td>
                        <td><?php echo $row['collfullname']; ?></td>
                        <td><?php echo $row['collshortname']; ?></td>
                        <td>
                            <a href="college-edit.php?collid=<?php echo $row['collid']; ?>" class="btn btn-primary btn-sm">
                        ...
                        <td>
                            <a href="delete.php?collid=<?php echo $row['collid']; ?>" class="btn btn-danger btn-sm" onclick="return confirmAction()">                        
